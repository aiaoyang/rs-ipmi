...
pub enum CompletionCode {
    ...
    UnspecifiedError,
    ParameterNotSupport,
    AttemptToSetTheSetInProgressValueWhenNotInTheSetCompleteState,
    AttemptToWriteReadOnlyParameter,
    OEM(u8),
    CommandCode(u8),
    Reserved(u8),
}
...
impl From<u8> for CompletionCode {
    fn from(value: u8) -> Self {
        match value {
            ...
            0x80 => CompletionCode::ParameterNotSupport,
            0x81 => CompletionCode::AttemptToSetTheSetInProgressValueWhenNotInTheSetCompleteState,
            0x82 => CompletionCode::AttemptToWriteReadOnlyParameter,
            0x83..=0xbe => CompletionCode::CommandCode(value),
...
impl From<CompletionCode> for u8 {
    fn from(value: CompletionCode) -> u8 {
        match value {
            ...
            CompletionCode::ParameterNotSupport => 0x80,
            CompletionCode::AttemptToSetTheSetInProgressValueWhenNotInTheSetCompleteState => 0x81,
            CompletionCode::AttemptToWriteReadOnlyParameter => 0x82,

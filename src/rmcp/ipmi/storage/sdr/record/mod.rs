...
use crate::{commands::CommandCode, ECommand, Error, Lun};

use super::{
    event_reading_type_code::EventReadingTypeCodes, sensor_type::SensorType, RecordId, Unit,
};
...
//     fn log(&self) -> Vec<crate::fmt::LogItem> {
